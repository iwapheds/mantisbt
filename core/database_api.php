 ...
 * @param integer $p_num_days     Number of days to compare against
 *                                (Should not be negative to avoid issues
 *                                with unsigned integers on MySQL).
 ...
 */
function db_helper_compare_days( $p_val_or_col_1, $p_val_or_col_2, $p_operator, $p_num_days ) {
	return "($p_val_or_col_1 $p_operator $p_val_or_col_2 + $p_num_days)";
}
